...
export const ForgotPassword: FC<Props> = ({ open, setOpen }) => {
  ...
  const restorePassword = async () => {
    ...
    setMessage(
      data.message ||
        "Error al enviar el correo, revisa los datos que estás enviando"
    );
    setShowMessage(true);
  };
  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth>
        ...
        <DialogContent>
          <DialogContentText>
            Danos tu correo electrónico y te enviaremos una contraseña temporal
        ...
        <DialogActions>
          ...
          <Button onClick={restorePassword}>Enviar correo</Button>
        </DialogActions>
        {showMessage && (
          <Alert
            onClose={handleClose}
